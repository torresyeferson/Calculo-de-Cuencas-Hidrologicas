...
public class FiltraEntrada extends DocumentFilter{
        ...
        for(int i=0;i<letras.length;i++)
        {
            ...
            switch(tipoEntrada)
            {
                case SOLO_NUMEROS:
                    ...
                    break;
                case SOLO_LETRAS:
                    if(Character.isLetter(letras[i]) && !letrasPermitidas(letras[i]))
                    {  
                       valido = true; 
                    }                        
                    break;
                case NUM_LETRAS:
                    if(Character.isDigit(letras[i] )|| letrasPermitidas(letras[i]))
                        valido = true;
                    break;
                case DEFAULT:                    
                    valido = true;
    ...
    private boolean letrasPermitidas(char cr)
    {
